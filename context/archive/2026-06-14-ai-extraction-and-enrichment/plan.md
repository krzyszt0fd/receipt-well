...
- [x] 6.2 Path filters trigger correctly (functions push triggers; backend-only push does not)
- [x] 6.3 Both workflows publish without build/restore errors in CI
