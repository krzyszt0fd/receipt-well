...
- [x] 1.1 Backend builds without warnings: `dotnet build src/backend/ReceiptWell.csproj` — e5d18ed
- [x] 1.2 `dotnet restore` updates `packages.lock.json` without errors — e5d18ed

#### Manual

- [x] 1.3 Application starts and logs Information for index initialization — e5d18ed
- [x] 1.4 Azure AI Search index visible in portal with all expected fields — e5d18ed
- [x] 1.5 `GET /health` returns 200 — e5d18ed
