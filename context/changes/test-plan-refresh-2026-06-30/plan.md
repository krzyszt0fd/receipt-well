...
- [ ] 2.1 Header line reads "Last updated: 2026-06-30"
- [ ] 2.2 §3 Phase 5 row Status reads "implementing"
- [ ] 2.3 §5 e2e gate "Where" reads "CI on push to develop"
- [ ] 2.4 §8 reads "Strategy (§1–§5) last reviewed: 2026-06-30"
- [ ] 2.5 File parses as valid markdown (no broken table rows)

#### Manual

- [ ] 2.6 §3 Phase 5 goal names both specs + CI wired; other cells unchanged
- [ ] 2.7 §4 Playwright row shows version 1.61.1 and "Live in `src/e2e-tests/`"
- [ ] 2.8 §6.6 E2E block has three bullets
- [ ] 2.9 No unintended edits outside the six target sections (verified via diff)
